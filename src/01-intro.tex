...
Considering job migration at edge servers, the authors in \cite{ToN-xujie2018} optimized the edge computing performance (e.g., latency) in a distributed manner with limited energy resources via a congestion game framework.
