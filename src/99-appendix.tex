...
Based on the previous definition in the time slot, the explicit definition is given as
\begin{align}
...
\begin{align}
    \mat{P}_{m,j}(\tilde{\beta}_{m,j}(t)) \define \prod_{n=0,\dots,N-1} \hat{\mat{P}}_{m,j}(t,n)
\end{align}
...
Under baseline policy $\Baseline$,
\begin{align}
