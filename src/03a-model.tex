...
\fixit{(define dispatching action) Let $\omega_{k,j}$ denotes the index of edge server for the processing of the $j$-th types of jobs dispatched from the $k$-th AP.}
...
\fixit{Moreover, different types of jobs may have different distributions on the sizes of computation data.}
...
\fixit{
    ...
    It is assumed taht the distributions of uploading delay of different jobs are independent.
}
...
Hence, we denote $\mathcal{C}_{m,j}$ as the processing time distribution \fixit{(with the unit of time slot)} of $j$-th type job on the $m$-th edge serer whose range is between $0$ and $c$.
...
\fixit{We highlight the life cycle of the job being processed.}
%----------------------------------------------------------------------------------------%
