...
\fixit{It's assumed that the distributions of uploading delays are independent and time-invariant between any two in uploading jobs.}
...
\fixit{
    This implies that one AP could not know when exactly other APs update their state in one period, and they could not come to consensus on the same state, until the end of the period.
    In the worst case, the APs would always update their dispatching decision only at the end of the period.
}
