...
The broadcast LSI of the $m$-th edge server at the $t$-th broadcast is defined as follows.
\begin{align}
    \mathcal{Q}_{m}({t}) \define \set{Q_{m,j}({t}) | \forall j\in\jSpace}.
\end{align}
And we have the \emph{global state information} (GSI) which is composed of all the broadcast information from all APs and edge servers at the $t$-th broadcast denoted as follows.
\begin{align}
