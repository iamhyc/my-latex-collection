...
We refer to the \emph{global state information} (GSI) as the composition of all the broadcast information from all APs and edge servers in one broadcast and the definition is given as follows.
...
\fixit{
    One AP will update its dispatching decision after the reception of the GSI.
...
\fixit{
    (There is no such OSI definition!)\\
