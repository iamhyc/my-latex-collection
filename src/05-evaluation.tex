...
\fixit{
    we evaluate the performance of the proposed low-complexity sub-optimal scheduling policy (Algorithm 1) by numerical simulations.
    ...
    The following four benchmark schemes are compared with the proposed scheduling scheme.
}
