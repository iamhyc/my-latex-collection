\begin{abstract}
    ...
    \delete{v6.2}{
        In this paper, we formulate the job dispatching problem in distributed Edge Computing system, and identify that the difficulty exists in how the decision is made decentralized based on stale information sharing.
