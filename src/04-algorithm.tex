...
\fixit{
    Hence, let what=what be the aggregation of dispatching actions for the APs in the subset $\mathcal{Y}_{n}$, and $xx=xx$ be the aggregation of dispatching actions of all APs.
