...
\begin{lemma}[Performance Guarantee]
    ...
    Let $W_{\tilde{\Omega}}(\cdot)$ be the value function of the policy $\tilde{\Omega}$ where
    $\tilde{\Omega}(\Stat(t)) \define \tilde{\mathcal{A}}(t)$, and
    ...
    \begin{align}
        ...
        \leq W_{\tilde{\Omega}}\Paren{\Stat(t)}
