...
To overcome the gap, we leverage the above global problem structure, but develop \fixit{$K$ sub-problems} where the APs update their own policy independently in a decentralized manner.
