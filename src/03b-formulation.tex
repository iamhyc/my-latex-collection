...
\begin{definition}[Per Time-slot Cost]
    \begin{align}
...
\fixit{
    However, due to the randomness of \brlatency~, it's impossible for any AP to obtain the \brlatency~information of other APs in on interval, and thus a centralized agent is impractical.
    
    However, due to the randomness of \brlatency~which follows independent distribution of each AP, it's impossible for any AP to obtain timely \brlatency~information of other APs in one broadcast interval.
