...
% As each AP would always update its dispatching policy based on the latest broadcast information, the \brlatency{s} in each interval is also taken as a part of state information.
