...
Due to the different distributions of \brdelay~for each AP, APs update their policy at different time slots in an unknown order \delete{which makes it impossible to optimize all the APs at once}.
Hence, to overcome the gap, we have to distributed optimize the dispatching policy of each AP.
\delete{
