...
\begin{itemize}
    ...
    \item fully cooperative mult-agent system (MAS), each agent shares the same utility function;
    \item The resulting joint action influences the evolution of the system; ("Sequential Optimality and Coordination in Multi-agent Systems", Craig Boutilie, 1999) ("Taming Decentralized POMDPs: Towards Efficient Policy Computation for Multi-agent Settings", R.Nair, 2003)
