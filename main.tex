    ...
    \begin{section}{PROBLEM FORMULATION}
        ...
        \begin{subsection}{The Optimization Problem}
            ...
            \begin{align}
                V(\Stat_{i}) =& g(\Stat_i)
                \nonumber\\
                &+ \gamma \min_{\Policy(\Stat_{i})} \sum_{\Stat_{i+1}} \sum_{d_k} \Pr\{ \Stat_{i+1}|\Stat_{i}, \Policy(\Stat_{i}) \} V(\Stat_{i+1}),
            \end{align}
