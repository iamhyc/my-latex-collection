...
\begin{document}
    ...
    \begin{section}{INTRODUCTION}
        ...
        \begin{itemize}
            ...
            \item \text{[online learning, multi-agent MDP, reduced state]} \cite{Zheng2019} is a work considering maximizing the long-term utility in MEC offloading policy, and formulating the problem with MDP solved with Q-learning;
