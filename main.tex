...
\begin{document}
    ...
    \begin{section}{INTRODUCTION}
        ...
        \begin{itemize}
            ...
            \item \text{[IEEE Access, baseline]} \cite{Fan2017} considers cooperation of multiple MEC-BSs of computation offloading which minimizes total cost of time and energy consumption.
            ...
            \item \text{[centralized, offloading, reduced state MDP]} \cite{Zheng2019} is a work considering maximizing the long-term utility in MEC offloading policy, and formulating the problem with MDP solved with Q-learning (the solution would take long time to converge and take effects, and less performed than our one-step iteration policy);
    ...
    \begin{section}{SYSTEM MODEL}
        ...
        \begin{subsection}{Network Model}
            ...
            % The maximum job processing time is bounded with $L_C$ in this system, and the job space is denoted as $\jSpace$.
