...
\begin{document}
    ...
    \begin{section}{ALGORITHM}
        \label{sec:algorithm}
        As the formulated problem is with infinite states and the action space would be exponentially expanded with respect to number APs and ESs, we could not use traditional \emph{policy iteration} or \emph{value iteration} algorithm for unacceptable complexity.
    \end{section}
